...
class config {
  ...
  function __construct($is_doc = false) {
    ...
    if($is_doc) self::$assets = empty(self::$config['assets']) ? 'https://fastly.jsdelivr.net/npm/' : rtrim(self::$config['assets'], '/') . '/';
...
if(post('action')){
  ...
  // do update
    ...
    $get = @file_get_contents('https://fastly.jsdelivr.net/npm/files.photo.gallery@' . $version . '/index.php');
...
var CodeMirror = {};
    ...
    <script src="https://fastly.jsdelivr.net/npm/toastify-js@1.12.0/src/toastify.min.js"></script>
    <script src="https://fastly.jsdelivr.net/npm/sweetalert2@11.7.20/dist/sweetalert2.min.js"></script>
    ...
    <script src="https://fastly.jsdelivr.net/npm/filesize@9.0.11/lib/filesize.min.js"></script>
    <script src="https://fastly.jsdelivr.net/npm/screenfull@5.2.0/dist/screenfull.min.js"></script>
    <script src="https://fastly.jsdelivr.net/npm/dayjs@1.11.9/dayjs.min.js"></script>
    <script src="https://fastly.jsdelivr.net/npm/dayjs@1.11.9/plugin/localizedFormat.js"></script>
    <script src="https://fastly.jsdelivr.net/npm/dayjs@1.11.9/plugin/relativeTime.js"></script>
    ...
    <script src="https://fastly.jsdelivr.net/npm/codemirror@5.65.14/mode/meta.js"></script>
